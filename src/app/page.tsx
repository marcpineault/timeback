      ...
      <section className="py-12 sm:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Link
              href="/sign-up"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white rounded-lg font-medium text-base sm:text-lg transition-colors text-center"
            >
              Start Free Trial
            </Link>
            <Link
              href="/pricing"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gray-800 hover:bg-gray-700 active:bg-gray-600 text-white rounded-lg font-medium text-base sm:text-lg transition-colors text-center"
            >
              View Pricing
            </Link>
          </div>
          <p className="text-gray-500 mt-4 text-sm sm:text-base">No credit card required. 3 free videos per month.</p>
        </div>
      </section>

      {/* Features */}
      <section className="py-12 sm:py-20 px-4 bg-gray-800/50">
      ...
      <footer className="py-6 sm:py-8 px-4 border-t border-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-sm text-gray-500">
            ...
            <span className="text-xs sm:text-sm">support@timebackvideo.com</span>
          </div>
        </div>
      </footer>
    </div>
