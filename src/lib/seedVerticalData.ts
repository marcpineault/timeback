...
export async function ensureVerticalDataSeeded() {
  ...
  if (calendarCount === 0) {
    const calendarEntries: {
      ...
      { vertical: 'MORTGAGE_BROKER', month: 3, title: 'BoC Rate Decision Reaction', description: 'React to the latest Bank of Canada rate announcement', contentAngle: "The BoC just announced — here's what it means for your mortgage", category: 'rate_reactions', isRecurring: true, specificDate: new Date('2026-03-12') },
      ...
      { vertical: 'MORTGAGE_BROKER', month: 4, title: 'BoC Rate Decision Reaction', description: 'April rate decision reaction and analysis', contentAngle: "Rate decision day — here's my breakdown", category: 'rate_reactions', isRecurring: true, specificDate: new Date('2026-04-16') },
      ...
      { vertical: 'MORTGAGE_BROKER', month: 6, title: 'BoC Rate Decision Reaction', description: 'Mid-year rate decision', contentAngle: 'June rate decision — what it means for summer buyers', category: 'rate_reactions', isRecurring: true, specificDate: new Date('2026-06-04') },
      ...
      { vertical: 'MORTGAGE_BROKER', month: 7, title: 'BoC Rate Decision Reaction', description: 'Summer rate decision', contentAngle: "Mid-summer rate check — here's where we stand", category: 'rate_reactions', isRecurring: true, specificDate: new Date('2026-07-16') },
      ...
      { vertical: 'MORTGAGE_BROKER', month: 9, title: 'BoC Rate Decision Reaction', description: 'Fall rate decision', contentAngle: 'September rate decision — fall market outlook', category: 'rate_reactions', isRecurring: true, specificDate: new Date('2026-09-10') },
      ...
      { vertical: 'MORTGAGE_BROKER', month: 10, title: 'BoC Rate Decision Reaction', description: 'October rate decision', contentAngle: 'Rate decision day — closing before year-end?', category: 'rate_reactions', isRecurring: true, specificDate: new Date('2026-10-29') },
      ...
      { vertical: 'FINANCIAL_ADVISOR', month: 4, title: 'Tax Day Content', description: 'Last-minute tax tips and IRA contribution deadline', contentAngle: "You have until April 15 to contribute to last year's IRA", category: 'seasonal', isRecurring: true, specificDate: new Date('2026-04-15') },
