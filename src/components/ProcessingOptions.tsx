    ...
    <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl p-4 sm:p-6 space-y-5 sm:space-y-6">
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-base sm:text-lg font-medium text-white">AI Speech Correction</h3>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
        ...
        <p className="text-xs text-gray-500">
          Uses AI to detect and automatically remove speech mistakes like stutters, filler words, and self-corrections
        </p>
        ...
        {config.speechCorrection && (
          <div className="space-y-4 pt-2 border-t border-gray-700">
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-400">What to Remove</label>
              <div className="grid grid-cols-2 gap-2">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded bg-gray-700 border-gray-600 text-purple-500 focus:ring-purple-500"
                  />
                  <span className="text-sm text-gray-400">Repeated words</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    className="w-4 h-4 rounded bg-gray-700 border-gray-600 text-purple-500 focus:ring-purple-500"
                  />
                  <span className="text-sm text-gray-400">False starts</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    className="w-4 h-4 rounded bg-gray-700 border-gray-600 text-purple-500 focus:ring-purple-500"
                  />
                  <span className="text-sm text-gray-400">Self-corrections</span>
                </label>
              </div>
              <p className="text-xs text-gray-500">
                Filler words: um, uh, like, you know | Repeated: the the, I I | False starts: incomplete restarts | Self-corrections: wrong word then fix
              </p>
            </div>

            {/* Aggressiveness */}
            <div>
              <label className="block text-sm text-gray-400 mb-2">Correction Level</label>
              ...
              <p className="text-xs text-gray-500 mt-1">
                ...
                {config.speechCorrectionConfig.aggressiveness === 'moderate' && 'Balanced - removes most mistakes while preserving natural speech'}
                {config.speechCorrectionConfig.aggressiveness === 'aggressive' && 'Maximum polish - removes all detected issues'}
              </p>
            </div>
          </div>
        )}
